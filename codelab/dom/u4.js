...

    {
      ...
      questions: [
        { q: "A user types 5 into `<input id=\"qty\" type=\"number\">`. What does `qty.value` give you?",
          choices: ["The number 5, ready for arithmetic", "The string \"5\", not the number 5", "undefined until the form is submitted", "The number 5, once a change event fires"],
          answer: 1, explain: "Even a type=\"number\" input hands back a string — inputs ALWAYS do. \"5\" + \"5\" is \"55\", not 10, so wrap it in Number() before any math. And .value is readable the whole time; it never waits for submit or change." },
        ...
        { q: "What does this log?",
          ...
          lang: "js",
          choices: ["The string \"8020\"", "The number 100", "NaN, a not-a-number result", "A TypeError at runtime"],
          answer: 0, explain: ".value is always a string, and + between two strings glues them end to end. Number(bill) + Number(tip) gives the 100 you wanted. JavaScript never throws for + on strings, and NaN only shows up when a conversion fails." },
        ...
        { q: "For live, per-keystroke validation you should listen for…",
          choices: ["change, which fires on every keystroke", "input, which fires on every edit", "submit, once the whole form is sent", "keydown, but only when e.key is \"Enter\""],
          answer: 1, explain: "input fires every time the value changes — typing, pasting, clearing, dragging text in. change waits until the field loses focus, far too late for live feedback, and submit fires once at the very end." },
