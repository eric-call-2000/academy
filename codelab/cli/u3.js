...
window.CODELAB.addUnit("cli", {
  ...
  cheat: [
    ...
    { h: "Finding a line", lang: "sh", code: "grep ERROR app.log        # lines containing ERROR\ngrep -i error app.log     # ignore case\ngrep -n ERROR app.log     # show line numbers\ngrep -v DEBUG app.log     # lines that do NOT match\ngrep -c ERROR app.log     # just the count\ngrep -q ERROR app.log     # print NOTHING, just set the exit code", note: "grep prints matching lines and exits 0; it exits 1 when nothing matched. That exit code is what makes grep useful inside scripts, and Unit 4 puts it to work." },
  ...
  lessons: [
...

    {
      ...
      example: { lang: "sh", code: "head -n 3 app.log\n# boot: starting\n# boot: config loaded\n# db: connected\n\ntail -n 2 app.log\n# GET /  200\n# shutdown: clean\n\nwc -l app.log\n# 12 app.log\n\nwc users.csv\n# 4 4 47 users.csv    ← lines, words, characters" },
      steps: [
